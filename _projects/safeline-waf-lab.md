...
Configured detection policies and rate-limiting rules, performed log analysis to tune false positives and documented network topology for reproducibility.

**What you see:** reverse-proxy topology, WAF policy config, attack validation logs.
